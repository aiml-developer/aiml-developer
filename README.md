...
I live in Istanbul, Turkey, and completed my bachelor's degree in Electrical and Electronics Engineering, I am continuing my thesis-based master's degree in Computer Engineering at Kocaeli University. I have enhanced my software skills through courses from various institutions.

I am a software engineer in Java-based backend web application development, with a skill set that includes Java 8+, Spring Boot, SQL, JPA/Hibernate, RESTful APIs and Spring Security. I like to work on Microservice architecture. I have an interest in developing Financial and Insurance application.
